...
def cuda_extension() -> tuple[list, dict]:
    ...
    sysram_sources = [
        "csrc/storage_backends/sysram/core.cpp",
        "csrc/storage_backends/sysram/pybind.cpp",
    ]
    ext_modules = [
        ...
        cpp_extension.CppExtension(
            "lmcache.lmcache_sysram",
            sources=sysram_sources,
            include_dirs=["csrc/storage_backends", "csrc/storage_backends/sysram"],
            extra_compile_args={
                "cxx": [flag_cxx_abi, "-O3", "-std=c++17"],
            },
        ),
