...
# First Party
from lmcache.storage_backend.connector import ConnectorAdapter, ConnectorManager
...
def test_discover_adapters(monkeypatch):
    ...
    fake_package = ModuleType("lmcache.storage_backend.connector")
    ...
    def fake_import_module(name):
        ...
        if name == "lmcache.storage_backend.connector":
            return fake_package
