...
- Device detection via the registry-driven
  :func:`lmcache.platform._detect_device`.
- Factory dispatch in :func:`lmcache.gpu_connector.CreateGPUConnector`,
...
import lmcache.gpu_connector as gpu_connector_module
...
def _detect_with_stub(stub: _StubTorch) -> tuple[Any, str]:
    ...
    # First Party
    from lmcache.platform import _detect_device
...
def test_create_gpu_connector_musa_dispatches_to_musa_connector(
    ...
    _patch_device(monkeypatch, "musa")
    # First Party
    from lmcache.gpu_connector import musa_connectors as musa_mod
