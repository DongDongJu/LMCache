...
from lmcache.storage_backend.gds_backend import (
    _DATA_FILE_SUFFIX,
...
from tests.utils import create_test_memory_obj, has_cufile, has_hipfile
...
class TestGdsBackend:
    ...
    async def test_async_save_bytes_metadata_write_failure(
        ...
        with mock.patch(
            "lmcache.storage_backend.gds_backend.save_metadata",
    ...
    def test_weka_initialization_suffix(self, temp_gds_path, async_loop):
        ...
        with mock.patch.dict(sys.modules, {"cufile": dummy_cufile_module}):
            with (
                mock.patch(
                    "lmcache.storage_backend.gds_backend.get_fstype",
                    return_value="wekafs",
                ),
                mock.patch.object(
                    GdsBackend,
    ...
    def _make_mocked_backend(
        ...
        with (
            ...
            mock.patch(
                "lmcache.storage_backend.gds_backend.ctypes.CDLL",
