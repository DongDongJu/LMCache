...
from lmcache.storage_backend import LocalCPUBackend
from lmcache.storage_backend.connector import CreateConnector
from lmcache.storage_backend.valkey.worker_pool import GET_MISS, ValkeyWorkerPool
...
def mock_thread_worker_pool():
    ...
    MockThreadWorkerPool.last_init_kwargs = {}
    with patch(
        "lmcache.storage_backend.connector.valkey_connector.ValkeyWorkerPool",
...
def test_valkey_ttl_sec_enabled_without_value_uses_default(
    ...
    # First Party
    from lmcache.storage_backend.connector.valkey_connector import (
        DEFAULT_TTL_SECS,
    )
