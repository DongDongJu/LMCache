...
from lmcache.storage_backend.connector import ConnectorContext
from lmcache.storage_backend.connector.hfbucket_adapter import (
    HFBucketConnectorAdapter,
)
from lmcache.storage_backend.connector.hfbucket_connector import (
    HFBucketConnector,
...
def test_adapter_create_connector_uses_plugin_scoped_config(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "lmcache.storage_backend.connector.hfbucket_adapter.HFBucketConnector",
        DummyConnector,
    )
