...
# First Party
from lmcache.config import LMCacheEngineConfig  # noqa: E402
from lmcache.memory_management import MemoryObj  # noqa: E402
from lmcache.metadata import LMCacheMetadata  # noqa: E402
from lmcache.storage_backend.connector.bigtable_connector import (  # noqa: E402
    BigtableConnector,
)
from lmcache.storage_backend.local_cpu_backend import LocalCPUBackend  # noqa: E402
from lmcache.storage_backend.remote_backend import RemoteBackend  # noqa: E402
from lmcache.utils import CacheEngineKey  # noqa: E402
from tests.utils import create_test_memory_obj  # noqa: E402
...
def mock_pq_executor():
    ...
    with patch(
        "lmcache.storage_backend.connector.bigtable_connector.AsyncPQExecutor"
    ) as mock:
        instance = MagicMock()
...
class TestBigtableConnector:
    ...
    def test_get_client_credentials_os_error(self, async_loop, local_cpu_backend):
        ...
        with (
            ...
            patch(
                "lmcache.storage_backend.connector.bigtable_connector.logger.warning"
            ) as mock_warning,
        ):
            client = connector._get_client()
    ...
    def test_bigtable_config_defaults(self):
        ...
        # First Party
        from lmcache.storage_backend.connector.bigtable_config import (
    ...
    def test_dual_mode_write(self, async_loop, memory_allocator):
        ...
        with patch(
            "lmcache.storage_backend.connector.bigtable_connector.len",
