...
"""Tests for :mod:`lmcache.storage_backend.path_sharder`."""
...
class TestPathSharder:
    ...
    @patch(
        "lmcache.storage_backend.path_sharder.torch_dev.is_available",
        return_value=False,
    )
    ...
    @patch(
        "lmcache.storage_backend.path_sharder.torch_dev.current_device",
        return_value=1,
    )
