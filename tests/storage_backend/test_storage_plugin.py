...
from lmcache.event_manager import EventManager
...
MOCK_BACKEND_EXTRA_CONFIG = {
    "storage_plugin.mock_backend.module_path": (
        "tests.storage_backend.test_storage_plugin"
    ),
