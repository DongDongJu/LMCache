...
# First Party
from lmcache.memory_management import MemoryFormat, MemoryObj
from lmcache.storage_backend.pd_backend import AllocRequest as SyncAllocRequest
from lmcache.storage_backend.pd_backend import AllocResponse as SyncAllocResponse
from lmcache.storage_backend.pd_backend import PDMsg as SyncPDMsg
from lmcache.storage_backend.pd_backend_async import AllocRequest as AsyncAllocRequest
from lmcache.storage_backend.pd_backend_async import AllocResponse as AsyncAllocResponse
from lmcache.storage_backend.pd_backend_async import (
    CancelNotif,
    PDBackendAsync,
)
from lmcache.storage_backend.pd_backend_async import PDMsg as AsyncPDMsg
from lmcache.storage_backend.pd_backend_async import (
    ProxyNotif,
)
...
def _pd_backend_patches():
    return (
        patch(
            "lmcache.storage_backend.pd_backend_async.get_zmq_context",
            return_value=MagicMock(),
        ),
        patch(
            "lmcache.storage_backend.pd_backend_async.CreateTransferChannel",
            return_value=MagicMock(),
        ),
        patch(
            "lmcache.storage_backend.pd_backend_async.get_correct_device",
            return_value="cpu",
        ),
    )
