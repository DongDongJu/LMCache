...
from lmcache.distributed.l2_adapters.mock_l2_adapter import MockL2AdapterConfig
from lmcache.distributed.l2_adapters.plugin_l2_adapter import PluginL2AdapterConfig
from lmcache.distributed.l2_adapters.raw_block_l2_adapter import (
...
class TestPluginAdapterFactory:
    ...
    def test_load_external_adapter(self, monkeypatch):
        ...
        # First Party
        from lmcache.distributed.l2_adapters import plugin_l2_adapter as plugin_mod
...
class TestLazyLoading:
    ...
    def _isolate_registry(self, monkeypatch):
        ...
        # First Party
        from lmcache.distributed.l2_adapters import factory as fmod
...
class TestCreateL2Adapter:
    ...
    def test_create_mock_adapter(self):
        ...
        # First Party
        from lmcache.distributed.l2_adapters import (
            create_l2_adapter,
        )
        from lmcache.distributed.l2_adapters.mock_l2_adapter import (
            MockL2Adapter,
...
class TestNativePluginFactory:
    ...
    def test_load_native_connector(self, monkeypatch):
        ...
        from lmcache.distributed.l2_adapters.native_plugin_l2_adapter import (
...
class TestFSNativeAdapterFactory:
    ...
    def test_factory_creates_adapter(self, monkeypatch):
        ...
        from lmcache.distributed.l2_adapters.fs_native_l2_adapter import (
