...
from lmcache.distributed.config import L1ManagerConfig, L1MemoryManagerConfig
from lmcache.distributed.l1_manager import L1Manager
from lmcache.distributed.l2_adapters.mock_l2_adapter import (
    MockL2Adapter,
    MockL2AdapterConfig,
)
from lmcache.distributed.storage_controllers.prefetch_controller import (
    PrefetchController,
)
from lmcache.distributed.storage_controllers.prefetch_policy import (
    DefaultPrefetchPolicy,
)
from lmcache.distributed.storage_controllers.store_controller import (
    StoreController,
)
...
from lmcache.memory_management import MemoryObjMetadata, TensorMemoryObj

# Importing this sets the process-wide MeterProvider with an
# InMemoryMetricReader; controllers bind their instruments to it.
from tests.mp_observability.subscribers.metrics.otel_setup import reader as _reader
