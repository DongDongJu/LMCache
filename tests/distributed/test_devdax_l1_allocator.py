...
from lmcache.distributed.memory_manager.devdax_l1_memory_manager import (
    DevDaxL1MemoryManager,
)
from lmcache.memory_allocators.devdax_memory_allocator import DevDaxMemoryAllocator
...
def test_devdax_overflow_rejects_single_region_l2_adapters(
    ...
    path = _make_mmap_file(tmp_path)
    monkeypatch.setattr(
        "lmcache.distributed.config.get_type_name_for_config",
