...
from lmcache.distributed.l2_adapters.config import L2AdaptersConfig
from lmcache.distributed.l2_adapters.fs_l2_adapter import FSL2AdapterConfig
...
def test_turboquant_direct_roundtrip_cuda(
    ...
    # First Party
    from lmcache.distributed.serde.turboquant import TurboQuantDeserializer
