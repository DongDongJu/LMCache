...
# First Party
from lmcache.gpu_connector.utils import normalize_and_discover_per_layer_formats
...
_VLLM_DEV = "lmcache.gpu_connector.kv_format.detectors.vllm.torch_device_type"
