...
# First Party
from lmcache.platform.musa import native_kv_transfer as musa_native
...
def test_native_transfer_module_lives_under_musa_platform() -> None:
    ...
    assert musa_native.__name__ == "lmcache.platform.musa.native_kv_transfer"
...
def test_get_backend_prefers_musa_ops_over_cuda_when_musa_is_available(
    ...
    # First Party
    from lmcache.platform import _detect_device, get_backend
    from lmcache.platform.musa import ops as musa_ops
