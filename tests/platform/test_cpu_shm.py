...
"""Tests for ``lmcache.platform.cpu.shm``.
...
def test_migrate_finalizer_unlinks_on_gc():
    ...
    # First Party
    from lmcache.platform.cpu.shm import shm_map_readwrite
...
def test_migrate_ignores_stale_entry_from_id_reuse():
    ...
    # First Party
    from lmcache.platform.cpu.shm import inject_stale_cache_entry_for_test
