...
def test_launch_plugins_location_does_not_exist():
    ...
    with patch("lmcache.plugin.runtime_plugin_launcher.logger") as mock_logger:
        launcher.launch_plugins()
...
@patch("lmcache.plugin.runtime_plugin_launcher.shutil.which")
@patch("lmcache.plugin.runtime_plugin_launcher.subprocess.Popen")
...
def test_launch_plugins_role_filtering(
    ...
    with (
        patch("lmcache.plugin.runtime_plugin_launcher.logger") as mock_logger,
...
def test_get_interpreter_python(temp_plugin_dir):
    ...
    with patch("lmcache.plugin.runtime_plugin_launcher.shutil.which") as mock_which:
...
@patch("lmcache.plugin.runtime_plugin_launcher.atexit.register")
