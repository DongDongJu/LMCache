...
def test_memory_allocators_package_import_is_lazy() -> None:
    ...
    _run_import_script(
        ...
        import lmcache.memory_allocators as allocators
        ...
        loaded = sorted(
            ...
            if name.startswith("lmcache.memory_allocators.")
...
def test_allocator_submodule_first_import_keeps_core_surface() -> None:
    ...
    _run_import_script(
        ...
        from lmcache.memory_allocators.tensor_memory_allocator import (
...
def test_multiple_allocator_submodule_imports_keep_core_surface() -> None:
    ...
    _run_import_script(
        """
        from lmcache.memory_allocators.devdax_memory_allocator import (
...
def test_memory_management_all_keeps_only_core_names() -> None:
    ...
    _run_import_script(
        """
        import lmcache.memory_management as memory_management
