...
```bash
curl -s http://127.0.0.1:18080/v2/apps/lmcache | jq

curl -s -X POST http://127.0.0.1:18080/v2/apps/lmcache/deallocations \
  -H 'content-type: application/json' \
  -d '{"request_id":"shrink-0001","target_node":"192.0.2.40",
       "device_path":"/dev/dax-cxl/lmcache-e2e--mp-196/dax0.1"}'

curl -s -X POST http://127.0.0.1:18080/v2/apps/lmcache/allocations \
  -H 'content-type: application/json' \
