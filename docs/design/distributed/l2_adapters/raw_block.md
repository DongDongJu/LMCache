...
- `RawBlockCore` in `lmcache/storage_backend/raw_block/`
- `RawBlockL2Adapter` in `lmcache/distributed/l2_adapters/`
...
- Implementation: `lmcache/distributed/l2_adapters/raw_block_l2_adapter.py`
- Shared core: `lmcache/storage_backend/raw_block/core.py`
