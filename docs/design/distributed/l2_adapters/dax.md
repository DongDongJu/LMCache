...
`lmcache/storage_backend/dax/core.py` defines `DaxCore[KeyT]`. The core owns
...
`lmcache/storage_backend/plugins/dax_backend.py` is the non-MP wrapper. It
...
`lmcache/distributed/l2_adapters/dax_l2_adapter.py` is the MP adapter. It
