# `lmcache.distributed.serde.turboquant` — TurboQuant Serde Backend
...
in [`docs/design/distributed/serde/README.md`](README.md) and the L2 adapter
wrapper described in
[`docs/design/distributed/l2_adapters/serde_wrapper.md`](../l2_adapters/serde_wrapper.md).
