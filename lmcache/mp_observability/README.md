...
For metrics, see [METRICS.md](../../docs/design/mp_observability/METRICS.md).
For event metadata contracts, see
[EVENTS.md](../../docs/design/mp_observability/EVENTS.md).
For design rationale, see
[event-bus.md](../../docs/design/mp_observability/event-bus.md).
For the trace recording subsystem (`lmcache trace`), see
[trace.md](../../docs/design/mp_observability/trace.md).
...
from lmcache.mp_observability.event import Event, EventType
from lmcache.mp_observability.event_bus import EventCallback, EventSubscriber
...
from lmcache.mp_observability.subscribers.metrics.my_component import (
...
if obs_config.metrics_enabled:
    from lmcache.mp_observability.subscribers.metrics import (
        MyComponentMetricsSubscriber,
    )
...
[EVENTS.md](../../docs/design/mp_observability/EVENTS.md) so
...
| Use `metadata: dict[str, Any]` for event payloads | Flexible, no coupling between producers and subscribers. See metadata contracts in [EVENTS.md](../../docs/design/mp_observability/EVENTS.md). |
