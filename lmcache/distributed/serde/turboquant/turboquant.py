...
from lmcache.distributed.serde.base import Deserializer, SerdeProcessor, Serializer
from lmcache.distributed.serde.factory import register_serde_factory
...
class TurboQuantSerializer(Serializer):
    ...
    def serialize(self, src: MemoryObj, dst: MemoryObj) -> int:
        ...
        if quant_layers:
            # First Party
            from lmcache.distributed.serde.turboquant.store_kernel import (
...
class TurboQuantDeserializer(Deserializer):
    ...
    def deserialize(self, src: MemoryObj, dst: MemoryObj) -> None:
        ...
        if quant_layers:
            # First Party
            from lmcache.distributed.serde.turboquant.decode_kernel import (
                _tq_full_dequant_kv,
                _use_fp8_e4b15,
            )
