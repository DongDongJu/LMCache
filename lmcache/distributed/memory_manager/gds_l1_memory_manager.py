...
from lmcache.distributed.config import GdsL1Config
...
class GDSL1MemoryManager:
    ...
    A peer of
    :class:`~lmcache.distributed.memory_manager.l1_memory_manager.L1MemoryManager`
    (both satisfy
    :class:`~lmcache.distributed.memory_manager.l1_manager_protocol.L1ManagerProtocol`).
    ...
    :class:`~lmcache.gpu_connector.gds_context.GDSContext`, reached from the
    ``gpu_ops`` dispatch.
