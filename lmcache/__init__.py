...
# --------------------------
from lmcache.platform import get_backend
from lmcache.platform import torch_dev as torch_dev
from lmcache.platform import torch_device_type as torch_device_type
