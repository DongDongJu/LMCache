...
* :mod:`lmcache.platform.cuda` -- CUDA-backed implementations.
* :mod:`lmcache.platform.cpu`  -- CPU-only fallbacks.

KV-cache IPC wrappers and ``BaseCacheContext`` subclasses are
discovered separately on first use via
:mod:`lmcache.utils.subclass_discovery`, keyed by each subclass'
...
from lmcache.platform.event_notifier import HAS_EVENTFD as HAS_EVENTFD
from lmcache.platform.event_notifier import EventfdNotifier as EventfdNotifier
from lmcache.platform.event_notifier import EventNotifier as EventNotifier
from lmcache.platform.event_notifier import PipeNotifier as PipeNotifier
from lmcache.platform.event_notifier import consume_fd as consume_fd
from lmcache.platform.event_notifier import (
