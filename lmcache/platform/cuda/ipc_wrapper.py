...
:func:`~lmcache.platform._registry._discover_wrappers_once` can
...
class CudaIPCWrapper(DeviceIPCWrapper):
    ...
    def wrap(cls, tensor: torch.Tensor) -> "CudaIPCWrapper":
        """Factory used by
        :func:`~lmcache.platform._registry._discover_wrappers_once`.
    ...
    def __init__(self, tensor: torch.Tensor) -> None:
        # First Party
        from lmcache.gpu_connector.kv_format.contiguity import (
