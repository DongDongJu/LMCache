...
Config module: ``lmcache/distributed/l2_adapters/aerospike_l2_adapter.py``.
...
- [ ] Optional: Aerospike integration (`RUN_AEROSPIKE_INTEGRATION=1`, see `tests/distributed/test_aerospike_l2_integration.py`)
